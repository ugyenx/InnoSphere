...
import { cartItem } from '../../store/atoms'
function Cart() {
  ...
  const removeProduct = (id) => {
    const updatedCart = cartItemList.filter(item => item.id !== id)
   setCartItemList(updatedCart)
    navigate('/cart')
  }
          ...
          <div className="w-3/4shadow-md my-10 flex-wrap">
                  ...
                  return (
                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                      <div className="flex w-2/5">
                        <div className="w-20">
                          <img className=" rounded-xl" src={cart?.img} alt={cart?.title} />
                        </div>
            ...
            <div id="summary" className="w-2/4 px-8 py-10 container">
              ...
              <div className="flex flex-wrap justify-between mt-10">
                <span className="font-semibold text-sm uppercase">Items {cartItemList?.length}</span>
              ...
              <div className="border-t mt-8 w-full">
                ...
                <Link to='/checkout'
                 className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 p-2 text-sm text-white rounded-xl uppercase w-full">Checkout</Link>
              </div>
            </div>
          </div>
       </div>
